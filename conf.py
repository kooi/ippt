...
html_title = 'Introductie Programmeren met Python Turtle'

# A shorter title for the navigation bar.  Default is the same as html_title.
#html_short_title = 'Introductie Programmeren met Python Turtle'
...
# pixels large.
html_favicon = "turtle_HrK_icon.ico"
